...
import java.util.Scanner;
    ...
    public class Collectionjava {
        public static void main(String[] args) {
            Employee em1 = new Employee("ayan", "Mukheed", 22, 90000);
            Employee em2 = new Employee("ranbir", "Kapoor", 26, 70000);
            Employee em3 = new Employee("Vere", "Akhila", 25, 36000);
            Employee em4 = new Employee("Shiva", "Prasad", 23, 79500);
            Employee em5 = new Employee("Hema", "latha", 21, 40000);
            ...
            Collectionjava m = new Collectionjava();
